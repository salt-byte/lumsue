  ...
  useEffect(() => {
    if (messages.length === 0) {
      const welcomeMsg: ChatMessage = {
        ...
        role: 'assistant',
        content: isNewUser 
          ? "您好，我是 Aura 实验室的首席护肤导师。很高兴能为您提供专业的皮肤学咨询。在开始深度诊断前，我们需要通过 AI 临床级扫描获取您的底层皮肤数据。您准备好开启首次肤质检测了吗？"
          : `欢迎回来。我是 Aura，您的私人皮肤专家。我一直在关注您的皮肤屏障修复进度。今天，您是想针对具体的皮肤问题进行深度咨询，还是希望通过最新的扫描数据来优化您的护肤方案？`,
        timestamp: Date.now(),
        options: isNewUser 
          ? ["开始扫描", "了解 App 功能"] 
